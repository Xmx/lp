    ...
    function send_companies_1(param)
    {
     $.ajax({
            ...
            success : function(data) { 
                ...
                else $('.table-invoices tbody').html('Nėra sąskaitų');
            ...
            success : function(data) { 
                ...
                if(new_table_content != '') 
                {
                  ...
                  $('#sum_all').html(all_sum.toFixed(2));
                   var sum_pvm = all_sum.toFixed(2) * 0.21;
                   $('#sum_pvm').html(sum_pvm.toFixed(2));
                   var sum_pvm_all = all_sum + sum_pvm;
                   $('#sum_all_pvm').html(sum_pvm_all.toFixed(2));
                }
