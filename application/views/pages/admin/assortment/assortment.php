        ...
        <div class="row">
                    ...
                    <?php
                        if(isset($companies))
                        {
                            foreach ($companies as $company) {
                               ?><tr value="<?php echo $company->company; ?>"> <td><?php echo $company->company; ?> </td></tr> <?php
                            }
                        }
                    ?>
        		</tbody>
			...
			<div class="column grid_9">
                ...
                <?php echo Form::button('create_new','',array('id'=>"create_new",'class'=>'left manage add')); ?>
                 <?php echo Form::button('delete','',array('id'=>"delete",'class'=>'left manage remove')); ?>
                 <?php echo Form::button('dupe','',array('id'=>"dupe",'class'=>'left manage dupe')); ?>
                </div>
                </div>
					<table class="table-assortment">
                        ...
                        <tr>
                            ...
                            <th><span class="text">Klijavimas</span></th>
...
<div class="column grid_6">
        ...
        <div class="popup">
       <div class="card-manage-border"><button class="exit manage remove"></button></div>
